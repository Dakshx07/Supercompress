...
// API-key auth lives on account?op=me (plain /api/me is Firebase-session only)
export const ME_URL =
  process.env.SUPERCOMPRESS_ME_URL || "https://www.supercompress.dev/api/account?op=me"
